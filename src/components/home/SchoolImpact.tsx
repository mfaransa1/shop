      ...
      <div className="shop-container py-24 md:py-32 lg:py-40">
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          ...
          <p className="max-w-sm text-sm leading-6 text-shop-muted md:pb-2">
            SHoP grows through the people and places that make chess accessible
            to young people.
          </p>
        </div>
        ...
        <div className="mt-16 grid border-t border-shop-border md:grid-cols-3">
          {highlights.map((item) => (
            <article
              key={item.number}
              className="border-b border-shop-border py-8 md:border-b-0 md:border-l md:px-8 md:first:border-l-0 md:first:pl-0"
            >
              <span className="text-[9px] font-bold tracking-[0.2em] text-shop-muted">
                {item.number}
              </span>

              <h3 className="shop-display mt-5 text-3xl md:text-4xl">
                {item.title}
              </h3>
        ...
        <div className="mt-12 flex flex-col gap-5 border-t border-shop-border pt-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          >
            <span className="!text-[#F3EDE2]">Work with SHoP</span>
