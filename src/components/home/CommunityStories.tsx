      ...
      <div className="shop-container py-24 md:py-32 lg:py-40">
        ...
        <div className="mt-20 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <article className="group">
            <div className="relative aspect-[4/3] overflow-hidden bg-[#111111]">
              ...
              <div className="absolute inset-x-0 bottom-0 p-7 md:p-10">
                ...
                <h3 className="shop-display mt-5 max-w-xl text-4xl leading-none text-white md:text-5xl lg:text-6xl">
                  {stories[0].title}
                </h3>
          ...
          <div className="grid gap-6">
            {stories.slice(1).map((story) => (
              <article
                key={story.number}
                className="group grid grid-cols-[120px_1fr] gap-5 border-b border-shop-border pb-6 sm:grid-cols-[160px_1fr]"
              >
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <h3 className="shop-display mt-4 text-2xl leading-none sm:text-3xl">
                    {story.title}
                  </h3>
                  ...
                  <span className="mt-4 text-shop-muted transition-transform duration-300 group-hover:translate-x-1">
                    →
                  </span>
                </div>
              </article>
        ...
        <div className="mt-20 border-t border-shop-border pt-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            >
              <span className="!text-[#F3EDE2]">Meet the community</span>
